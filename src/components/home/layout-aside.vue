<template>
    ...
    <div class="layout-aside">
        ...
        <el-menu :collapse="collaspse" router :style="{width: collaspse ? '60px': '230px'}" background-color="#353b4e"
            text-color="#adafb5" active-text-color="#ffd04b">
...
export default {
  ...
  data () {
    return {
      ...
      smallImg: require('../../assets/img/logo_admin.png')
    }
  }
}
</script>
